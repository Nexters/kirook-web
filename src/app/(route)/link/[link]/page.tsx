...
import { LinkTagCreateModal, type PaletteColors } from '@/app/(route)/link/components/LinkTagCreateModal';
...
import { decodeBase64UrlSafe } from '@/shared/utils/base64';
...
export default function LinkDetailPage({ params }: { params: { link: string } }) {
  console.log(params.link);
  console.log(decodeBase64UrlSafe(decodeURIComponent(params.link)));
  ...
  const { title, description, image, link } = { title: '', description: '', image: '', link: '' };
